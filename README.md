...
- **订阅计划** — 支持月/季/年订阅(自定义日期)，有效期内可访问所有归属该计划的文章
...
查看插件在 AB Store Web 上的详情页： https://ab-store.lhl.one/plugin/e478dae0

### 方式二：手动安装

1. 下载最新 [Release](https://github.com/lhl77/TypechoPaid/releases) / [AB Store Web](https://ab-store.lhl.one/plugin/e478dae0) 压缩包
